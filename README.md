...
- **Tauri 호환 자동 업데이트** — 기존 flipbookMaker GitHub Releases + minisign 키 재사용 가능
...
- **CheckUpdate**: `https://github.com/leonardo204/flipbookMaker/releases/latest/download/latest.json` 다운로드 → 버전 비교
- **DownloadAndInstall**:
